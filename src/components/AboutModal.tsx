import { X, Car, ArrowRightLeft, Shield, Sparkles, MessageCircle, Zap, FileText } from 'lucide-react';
        ...
        <div className="sticky top-0 bg-gradient-to-r from-cyan-600 to-blue-600 border-b border-cyan-500/30 px-6 py-4 z-10">
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-white">Informacije</h2>
            </div>
            <button
              onClick={onClose}
            ...
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-gray-800/50 to-gray-900/50 border border-gray-600/30 rounded-xl p-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-white">Uslovi korištenja platforme zamjenavozila.ba</h3>
                </div>
